...
if [[ "${CALLER_GTF_LD_DISPLAY_MODE}" != "__UNSET__" ]]; then
  GTF_LD_DISPLAY_MODE="${CALLER_GTF_LD_DISPLAY_MODE}"
fi
...
if [[ "${CALLER_GTF_LD_HEATMAP_LEGEND_TITLE}" != "__UNSET__" ]]; then
  GTF_LD_HEATMAP_LEGEND_TITLE="${CALLER_GTF_LD_HEATMAP_LEGEND_TITLE}"
fi
